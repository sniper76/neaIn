...
//	    private List<String> roles;
	    private List<CustomUserMenuInfoBean> menuList = new ArrayList<CustomUserMenuInfoBean>();
		...
		public List<CustomUserMenuInfoBean> getMenuList() {
			return menuList;
		}

		public void setMenuList(List<CustomUserMenuInfoBean> menuList) {
