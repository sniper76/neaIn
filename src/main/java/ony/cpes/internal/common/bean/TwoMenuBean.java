 ...
 * </pre>
 */
public class TwoMenuBean extends CommonBean{
	...
	private List<ThreeMenuBean> threeMenuList		=	new ArrayList<ThreeMenuBean>();
	...
	public List<ThreeMenuBean> getThreeMenuList() {
		return threeMenuList;
	}

	public void setThreeMenuList(List<ThreeMenuBean> threeMenuList) {
