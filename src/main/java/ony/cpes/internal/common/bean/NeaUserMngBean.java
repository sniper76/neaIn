 ...
 * </pre>
 */
public class NeaUserMngBean extends CommonBean{
	...
	private String nonNeaYn                 = "";
	private String workRetireCd             = "";
	private String workRetireNm             = "";
	private String insttNmCd                = "";
	private String userTel                  = "";
	private String delYn                    = "";
	private int pwdFailCnt                      ;
	private String oldPwd                   = "";
	private String urlChk                   = "";
	private List<NeaUserMngBean> list;
	 ...
	 * @return the list
	 */
	public List<NeaUserMngBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<NeaUserMngBean> list) {
		this.list = list;
	}
	/**
	 * @return the mngId
	 ...
	 * @return the nonNeaYn
	 */
	public String getNonNeaYn() {
		return nonNeaYn;
	}
	/**
	 * @param nonNeaYn the nonNeaYn to set
	 */
	public void setNonNeaYn(String nonNeaYn) {
		this.nonNeaYn = nonNeaYn;
	}
	/**
	 * @return the workRetireCd
	 */
	public String getWorkRetireCd() {
		return workRetireCd;
	}
	/**
	 * @param workRetireCd the workRetireCd to set
	 */
	public void setWorkRetireCd(String workRetireCd) {
		this.workRetireCd = workRetireCd;
	}
	/**
	 * @return the workRetireNm
	 */
	public String getWorkRetireNm() {
		return workRetireNm;
	}
	/**
	 * @param workRetireNm the workRetireNm to set
	 */
	public void setWorkRetireNm(String workRetireNm) {
		this.workRetireNm = workRetireNm;
	}
	/**
	 * @return the insttNmCd
	 */
	public String getInsttNmCd() {
		return insttNmCd;
	}
	/**
	 * @param insttNmCd the insttNmCd to set
	 */
	public void setInsttNmCd(String insttNmCd) {
		this.insttNmCd = insttNmCd;
	}
	/**
	 * @return the keyword
	 */
	...
	/**
	 * @param urlChk the urlChk to set
	 */
