 ...
 * </pre>
 */
public class ResumeSpcEduBean extends CommonBean{
	...
	private List<ResumeSpcEduBean> list;
	 ...
	 * @return the list
	 */
	public List<ResumeSpcEduBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<ResumeSpcEduBean> list) {
		this.list = list;
	}
	/**
	 * @return the cntryNm
