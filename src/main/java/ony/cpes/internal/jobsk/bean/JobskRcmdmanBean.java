 ...
 * </pre>
 */
public class JobskRcmdmanBean extends CommonBean{
	...
	private List<JobskRcmdmanBean> list;
	 ...
	 * @return the list
	 */
	public List<JobskRcmdmanBean> getList() {
		return list;
	}
	 ...
	 */
	public void setList(List<JobskRcmdmanBean> list) {
		this.list = list;
	}
