 ...
 * </pre>
 */
public class JobskWorkExpBean extends CommonBean{
	...
	private List<JobskWorkExpBean> list;
	 ...
	 * @return the list
	 */
	public List<JobskWorkExpBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<JobskWorkExpBean> list) {
		this.list = list;
	}
	/**
