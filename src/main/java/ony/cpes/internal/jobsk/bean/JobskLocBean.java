 ...
 * </pre>
 */
public class JobskLocBean extends CommonBean{
	...
	private List<JobskLocBean> list;
	 ...
	 * @return the list
	 */
	public List<JobskLocBean> getList() {
		return list;
	}
	 ...
	 */
	public void setList(List<JobskLocBean> list) {
		this.list = list;
	}	
