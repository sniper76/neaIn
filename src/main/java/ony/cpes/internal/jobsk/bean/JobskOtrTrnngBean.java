 ...
 * </pre>
 */
public class JobskOtrTrnngBean extends CommonBean{
	...
	private List<JobskOtrTrnngBean> list;
	 ...
	 * @return the list
	 */
	public List<JobskOtrTrnngBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<JobskOtrTrnngBean> list) {
		this.list = list;
	}
	/**
	 * @return the iscedNm
