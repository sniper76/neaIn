 ...
 * </pre>
 */
public class JobskSkillBean extends CommonBean{
	...
	private List<JobskSkillBean> list;
	 ...
	 * @return the list
	 */
	public List<JobskSkillBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<JobskSkillBean> list) {
		this.list = list;
	}
	/**
	 * @return the userSeq
