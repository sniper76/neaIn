 ...
 * </pre>
 */
public class JobskIntvwBean extends CommonBean{
	...
	private List<JobskIntvwBean> list;
	 ...
	 * @return the list
	 */
	public List<JobskIntvwBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<JobskIntvwBean> list) {
		this.list = list;
	}
	/**
