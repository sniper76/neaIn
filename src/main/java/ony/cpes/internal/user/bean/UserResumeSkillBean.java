 ...
 * </pre>
 */
public class UserResumeSkillBean extends CommonBean{
	...
	private List<UserResumeSkillBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeSkillBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<UserResumeSkillBean> list) {
		this.list = list;
	}
	/**
	 * @return the userSeq
