 ...
 * </pre>
 */
public class UserResumeIscoBean extends CommonBean{
	...
	private List<UserResumeIscoBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeIscoBean> getList() {
		return list;
	}
	 ...
	 */
	public void setList(List<UserResumeIscoBean> list) {
		this.list = list;
	}
