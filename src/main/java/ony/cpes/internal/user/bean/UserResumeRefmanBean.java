 ...
 * </pre>
 */
public class UserResumeRefmanBean extends CommonBean{
	...
	private List<UserResumeRefmanBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeRefmanBean> getList() {
		return list;
	}
	 ...
	 */
	public void setList(List<UserResumeRefmanBean> list) {
		this.list = list;
	}
