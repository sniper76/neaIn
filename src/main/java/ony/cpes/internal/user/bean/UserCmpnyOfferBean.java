 ...
 * </pre>
 */
public class UserCmpnyOfferBean extends CommonBean{
	...
	private String	aplicYnNm				= "";
	private String	vacancyTitle			= "";
	private String	regDt					= "";
	
	private List<UserCmpnyOfferBean> list;
	...
	/**
	 * @return the aplicYnNm
	 */
	public String getAplicYnNm() {
		return aplicYnNm;
	}
	/**
	 * @param aplicYnNm the aplicYnNm to set
	 */
	public void setAplicYnNm(String aplicYnNm) {
		this.aplicYnNm = aplicYnNm;
	}
	/**
	 ...
	 * @return the list
	 */
	public List<UserCmpnyOfferBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<UserCmpnyOfferBean> list) {
		this.list = list;
	}
	/**
