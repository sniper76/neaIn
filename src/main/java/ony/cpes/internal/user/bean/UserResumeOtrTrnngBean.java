 ...
 * </pre>
 */
public class UserResumeOtrTrnngBean extends CommonBean{
	...
	private List<UserResumeOtrTrnngBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeOtrTrnngBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<UserResumeOtrTrnngBean> list) {
		this.list = list;
	}
	/**
	 * @return the iscedNm
