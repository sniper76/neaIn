 ...
 * </pre>
 */
public class UserResumeLangBean extends CommonBean{
	...
	private List<UserResumeLangBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeLangBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<UserResumeLangBean> list) {
		this.list = list;
	}
	/**
	 * @return the langNm
