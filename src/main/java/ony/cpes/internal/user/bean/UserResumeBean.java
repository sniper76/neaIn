 ...
 * </pre>
 */
public class UserResumeBean extends CommonBean{
	...
	private List<UserResumeBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeBean> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<UserResumeBean> list) {
		this.list = list;
	}
	/**
	 * @return the marriNm
