 ...
 * </pre>
 */
public class UserResumeLocBean extends CommonBean{
	...
	private List<UserResumeLocBean> list;
	 ...
	 * @return the list
	 */
	public List<UserResumeLocBean> getList() {
		return list;
	}
	 ...
	 */
	public void setList(List<UserResumeLocBean> list) {
		this.list = list;
	}
