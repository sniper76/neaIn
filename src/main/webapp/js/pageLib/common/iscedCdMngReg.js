...
function insertIscedCdConf(){
    

    if ($('#khNm').val() == "") {
        alertify.alert(iscedNmKhMsg, function (e) {
            if (e) {
                $("#khNm").focus();
            }
        });
    ...
    if ($('#enNm').val() == "") {
        alertify.alert(iscedNmEnMsg, function (e) {
            if (e) {
                $("#enNm").focus();
            }
        });
...
function insertIscedCd(){
    
    var param = $("#frm").serialize();
    
    $.ajax({
        type : 'post', // 타입
        url :  contextPath + "/internal/common/insertIscedCdMngAjax.do", // URL
        dataType : 'json', // 데이터 타입
        //data : param,
        traditional: true,
        data : param,
