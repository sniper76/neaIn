...
$(document).ready(function() {
   ...
   $('#depth').change(function(e) {
    ...
    $('#oneDepth').change(function(e) {
        ...
        if(selectVal != ""){
            var param = {iscedId: selectVal,iscedCd: $('#txtIscedCd').val()};

            $.ajax({
                type : 'post', // 타입
                url :  contextPath + "/internal/common/selectIscedTwoListAjax.do", // URL
                ...
                success:function(result){
                    ...
                    if(result.twoDepth.length != null){
                        ...
                        for(var i in result.twoDepth){
                            ...
                            $('#twoDepth').append("<option value=\""+ depthobj.iscedId +"\">"+ depthobj.cateNm +"</option>");
                        }
                    }
    ...
    $('#twoDepth').change(function(e) {
        ...
        if(selectVal != ""){
            ...
            $.ajax({
                type : 'post', // 타입
                url :  contextPath + "/internal/common/selectIscedThreeListAjax.do", // URL
                dataType : 'json', // 데이터 타입
                traditional: true,
                data : param,
                success:function(result){
                    ...
                    if(result.threeDepth.length != null){
                        ...
                        for(var i in result.threeDepth){
                            ...
                            $('#threeDepth').append("<option value=\""+ depthobj.iscedId +"\">"+ depthobj.cateNm +"</option>");
                        }
                    }
    ...
    $('#threeDepth').change(function(e) {
        ...
        if(selectVal != ""){
            ...
            $.ajax({
                type : 'post', // 타입
                url :  contextPath + "/internal/common/selectIscedFourListAjax.do", // URL
                dataType : 'json', // 데이터 타입
                traditional: true,
                data : param,
                success:function(result){
                    ...
                    if(result.fourDepth.length != null){
                        ...
                        for(var i in result.fourDepth){
                            ...
                            $('#fourDepth').append("<option value=\""+ depthobj.iscedId +"\">"+ depthobj.cateNm +"</option>");
                        }
                    }
...
function oneDepthList(){
    var param = {iscedCd: $('#txtIscedCd').val()};
    $.ajax({
        type : 'post', // 타입
        url :  contextPath + "/internal/common/selectIscedOneListAjax.do", // URL
        dataType : 'json', // 데이터 타입
        traditional: true,
        success:function(result){
            ...
            if(result.oneDepth.length != null){
                ...
                for(var i in result.oneDepth){
                    ...
                    $('#oneDepth').append("<option value=\""+ depthobj.iscedId +"\">"+ depthobj.cateNm +"</option>");
                }
            }
...
function updateIscedCd(){
    var iscedCd = $('#txtIscedCd').val();
    $('#iscedCd').val(iscedCd);
    var param = $("#frm").serialize();
    
    $.ajax({
        type : 'post', // 타입
        url :  contextPath + "/internal/common/updateIscedCdMngAjax.do", // URL
        dataType : 'json', // 데이터 타입
        //data : param,
        traditional: true,
        data : param,
...
function forList(){
    ...
    location.href = contextPath + "/internal/common/iscedCdMngList.do";
