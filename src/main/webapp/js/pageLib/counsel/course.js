...
//			    	}
			    ...
			    columnDefs: [
                    ...
                    { targets: 2, render: function ( data, type, full, meta ) {
            				return "<a href=\"javascript:void(0);\" onclick=\"course.fn.pageAction('" + full.counselSeq + "');\">" + data + "</font>" ;
                    	}
                    },
...
//            });
		...
		fn: {
			...
			pageAction : function(counselSeq) {
				...
				sessionStorage.setItem(course.name + "." + course.method, JSON.stringify(sessData));

				$("#frmCourse").attr("method", "post");
				$("#frmCourse").attr("action", contextPath + "/internal/counsel/courseDtl.do");
				$("#frmCourse").submit();
			},
