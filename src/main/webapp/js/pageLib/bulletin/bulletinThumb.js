...
function insertBulletin(){
    ...
    $("#frm").attr("action", contextPath + "/internal/bulletin/bulletinThumbReg.do?pg="+$("#programId").val());
    $("#frm").submit();
...
function pageAction(bulletinSeq){
    ...
    $("#frm").attr("method", "post");
    $("#frm").attr("action", contextPath + "/internal/bulletin/bulletinThumbDtl.do?pg="+$("#programId").val());
    $("#frm").submit();
}
