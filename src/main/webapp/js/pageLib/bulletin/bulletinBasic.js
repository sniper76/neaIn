...
function insertBulletin(){
    ...
    $("#frm").attr("action", contextPath + "/internal/bulletin/bulletinBasicReg.do?pg="+$("#programId").val());
    $("#frm").submit();
...
function pageAction(bulletinSeq){
    ...
    $("#frm").attr("method", "post");
    $("#frm").attr("action", contextPath + "/internal/bulletin/bulletinBasicDtl.do?pg="+$("#programId").val());
    $("#frm").submit();
}
