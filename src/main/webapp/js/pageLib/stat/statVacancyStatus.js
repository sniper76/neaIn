	...
	var	statVacancyStatus = {
			name: 'statVacancyStatus',
			...
			afterBind: function() {
	    	    ...
	    	    var action = contextPath + "/internal/stat/statVacancyTotalStatusDailyAjax.do"
	    		var param = {
	    	    				jcCd : $('#jcCd').val(),
	...
	function fnUserTotalStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statVacancyTotalStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnJobCenterStatusDaily(){
	    ...
	    var action = contextPath + "/internal/stat/statVacancyJobCenterStatusDailyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnJobCenterStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statVacancyJobCenterStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnLocationStatusDaily(){
	    ...
	    var action = contextPath + "/internal/stat/statVacancyLocationStatusDailyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnLocationStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statVacancyLocationStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
