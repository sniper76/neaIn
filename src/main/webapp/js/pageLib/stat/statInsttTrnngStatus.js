	...
	var	statInsttTrnngStatus = {
			name: 'statInsttTrnngStatus',
			...
			afterBind: function() {
	    	    ...
	    	    var action = contextPath + "/internal/stat/statInsttTrnngTotalStatusDailyAjax.do"
	    		var param = {
	    	    				jcCd : $('#jcCd').val(),
	...
	function fnUserTotalStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statInsttTrnngTotalStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnJobCenterStatusDaily(){
	    ...
	    var action = contextPath + "/internal/stat/statInsttTrnngJobCenterStatusDailyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnJobCenterStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statInsttTrnngJobCenterStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnLocationStatusDaily(){
	    ...
	    var action = contextPath + "/internal/stat/statInsttTrnngLocationStatusDailyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnLocationStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statInsttTrnngLocationStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
