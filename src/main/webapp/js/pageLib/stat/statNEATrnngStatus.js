	...
	var	statNEATrnngStatus = {
			name: 'statNEATrnngStatus',
			...
			afterBind: function() {
	    	    ...
	    	    var action = contextPath + "/internal/stat/statNEATrnngTotalStatusDailyAjax.do"
	    		var param = {
	    	    				jcCd : $('#jcCd').val(),
	...
	function fnUserTotalStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statNEATrnngTotalStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnJobCenterStatusDaily(){
	    ...
	    var action = contextPath + "/internal/stat/statNEATrnngJobCenterStatusDailyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
	...
	function fnJobCenterStatusMonthly(){
	    ...
	    var action = contextPath + "/internal/stat/statNEATrnngJobCenterStatusMonthlyAjax.do"
		var param = {
	    		jcCd : $('#jcCd').val(),
				startDate: $('#startDate').val(),
				endDate: $('#endDate').val()
