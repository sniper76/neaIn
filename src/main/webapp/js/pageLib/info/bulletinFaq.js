var	bulletinFaq = {
    ...
    bind: function() {
        ...
        // init dataTable
        that$.dataTables = $('#bulletinFaqTable').DataTable({
            pageLength: 10,
            ...
            serverMethod: 'post',
            ajax: {
                url :  contextPath + "/internal/info/selectBulletinListAjax.do?orderColumns="+orderColumns+"&lang"+lang // URL
                ,dataType: "json"
                , data: function ( d ) {
                    return $.extend( {}, d, {
            ...
            columnDefs: [
                ...
                { targets: 1, render: function ( data, type, full, meta ) {
                        ...
                        if(full.ntcYn == "Y"){
                            html = "<button type=\"button\" class=\"bbs_btn type02 small writing\">Notice</button><a href=\"javascript:void(0);\" onclick=\"bulletinFaq.fn.pageAction('" + full.bulletinSeq + "');\">" + data + "</font>" ;
                        }else{
                            html = "<a href=\"javascript:void(0);\" onclick=\"bulletinFaq.fn.pageAction('" + full.bulletinSeq + "');\">" + data + "</font>" ;
                        }
                        return html;
                    }
                },
    ...
    fn: {
    	...
    	pageAction : function (bulletinSeq){
    	    ...
    	    $("#frmBulletinFaq").find("#bulletinSeq").val(bulletinSeq);
    	    ...
    	    $("#frmBulletinFaq").attr("method", "post");
    	    $("#frmBulletinFaq").attr("action", contextPath + "/internal/info/" + urlParam + ".do");
    	    $("#frmBulletinFaq").submit();
    	},
