var	bulletinThumbReg = {
    name: 'bulletinThumbReg',
    dataTables: null,
    ...
    afterBind: function() {
        ...
        $("#frmBulletinThumbReg").submit(function(e) {
        	var form$ = $("#frmBulletinThumbReg");
    ...
    fn: {
    	...
    	insertAction: function() {
    		var deferred = $.Deferred();
    	    var param = $("#frmBulletinThumbReg").serializeObject();
