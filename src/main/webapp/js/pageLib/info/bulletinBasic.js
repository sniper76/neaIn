var	bulletinBasic = {
    ...
    bind: function() {
        ...
        // init dataTable
        that$.dataTables = $('#bulletinBasicTable').DataTable({
            pageLength: 10,
            ...
            columnDefs: [
                ...
                { targets: 1, render: function ( data, type, full, meta ) {
                        ...
                        if(full.ntcYn == "Y"){
                            html = "<img src=\""+ contextPath + "/images/icon_info.png\"><a href=\"javascript:void(0);\" onclick=\"bulletinBasic.fn.pageAction('" + full.bulletinSeq + "');\">" + data + "</font>" ;
                        }else{
                            html = "<a href=\"javascript:void(0);\" onclick=\"bulletinBasic.fn.pageAction('" + full.bulletinSeq + "');\">" + data + "</font>" ;
                        }
                        return html;
                    }
                },
    ...
    fn: {
    	...
    	pageAction : function (bulletinSeq){
    	    ...
    	    $("#frmBulletinBasic").find("#bulletinSeq").val(bulletinSeq);
    	    ...
    	    $("#frmBulletinBasic").attr("method", "post");
    	    $("#frmBulletinBasic").attr("action", contextPath + "/internal/info/" + urlParam + ".do");
    	    $("#frmBulletinBasic").submit();
    	},
