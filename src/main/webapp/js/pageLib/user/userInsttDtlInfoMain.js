	...
	var	userInsttDtlInfoMain = {
			name: 'userInsttDtlInfoMain',
			...
			afterBind: function() {
				...
				var action = contextPath + "/internal/user/selectUserInsttDtlInfoBaseAjax.do"
	...
	function tabProfileDtlInfo(){
		...
		var action = contextPath + "/internal/user/selectUserInsttDtlInfoProfileAjax.do"
		var insttSeq = $('#insttSeq').val();
		var param = {
						insttSeq: insttSeq
					};
	...
	function tabTrnngProgDtlInfo(){
		
		$("#innerDtlInfo").empty();
		
		var action = contextPath + "/internal/user/selectUserInsttDtlInfoEduMainAjax.do"
		var insttSeq = $('#insttSeq').val();
		var param = {
						insttSeq: insttSeq
					};
	...
	function tabJobfairDtlInfo(){
		...
		var action = contextPath + "/internal/user/selectUserInsttDtlInfoJobfairMainAjax.do"
		var insttSeq = $('#insttSeq').val();
		var param = {
						insttSeq: insttSeq
					};
	...
	function goDetil() {
		$('#frmUserInsttDtlInfoMain').prop('action','/internal/user/userDtlInfoModify.do').submit();
	}
	
	function fnGoPageUserInsttInfoListBack(){
