	...
	var	userElementaryDtlInfoIntvwReg = {
			name: 'userElementaryDtlInfoIntvwReg',
	...
	function fnUserElementaryDtlInfoIntvwReg(){
		...
		*/
        ...
        $.ajax({
            type : 'post', // 타입
            url :  contextPath + "/internal/user/insertUserElementaryDtlInfoIntvwRegAjax.do", // URL
