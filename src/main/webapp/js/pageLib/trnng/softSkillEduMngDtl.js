...
var	softSkillEduMngDtl = {
		name: 'softSkillEduMngDtl',
		...
		afterBind: function() {
			...
			$("#frmSoftSkillEduMngDtl").submit(function(e) {
			    var form$ = $(this);
		...
		fn: {
			deleteAction : function(e) {
				var form$ = $('#frmSoftSkillEduMngDtl');
				...
				var options = {
				    method: 'post',
				    url: contextPath + '/internal/trnng/deleteSoftSkillEduMngAjax.do',
				    data: param,
				    dataType: 'json',
				};				
			...
			updateAction : function(params) {
				...
				var options = {
					    method: 'post',
					    url: contextPath + '/internal/trnng/updateSoftSkillEduMngAjax.do',
					    data: params.data,
					    dataType: 'json',
					};
...
function fnFileFormSave(){
		var params = {
			data: $('#frmSoftSkillEduMngDtl').serializeObject()
		};
	$.when( softSkillEduMngDtl.fn.updateAction( params ) ).done(function( result ) {
		alertify.alert( t( 'cpes.reg.success.msg' ), function (e) { if (e) {
			window.location.href = contextPath + '/internal/trnng/softSkillEduMng.do';
		} });
	}).fail(function ( result ) {
		$('#frmSoftSkillEduMngDtl').find("#btnDelete").attr('disabled', false);
		$('#frmSoftSkillEduMngDtl').find("#btnSubmit").attr('disabled', false);
