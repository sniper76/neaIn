var	softSkillEduMng = {
		...
		bind: function() {
			...
			that$.dataTables = $('#softSkillEduMngTable').DataTable({
				pageLength: 10,
			    ...
			    serverMethod: 'post',
			    ajax: {
			    	url: contextPath + '/internal/trnng/selectSoftSkillEduMngListAjax.do?orderColumns='+orderColumns
			    	, data: function ( d ) {
			        	return $.extend( {}, d, {
			    ...
			    columnDefs: [
			    	...
			    	{ targets: 1, render: function ( data, type, full, meta ) {
			    			return "<a href=\"javascript:void(0);\" onclick=\"softSkillEduMng.fn.pageAction('" + full.eduTrnngSeq + "');\"><span style=\"text-decoration: underline;\" >" + data + "</span></a>" ;
	            		}
	                },			    	
			    	...
			    	{ targets: 7, render: function ( data, type, full, meta ) {
			    			return "<a href=\"javascript:void(0);\" onclick=\"softSkillEduMng.fn.subscrAction('" + full.eduTrnngSeq + "');  \"><span style=\"text-decoration: underline;\" >" + data + "</span></a>" ;
	            		}
	                },
		...
		fn: {
			...
			pageAction : function(eduTrnngSeq) {
				$("#frmSoftSkillEduMng").find("#eduTrnngSeq").val(eduTrnngSeq);
				var sessData = $("#frmSoftSkillEduMng").serializeObject();
				sessionStorage.setItem(softSkillEduMng.name, JSON.stringify(sessData));

				var urlParam = eduTrnngSeq != '' ? 'softSkillEduMngDtl' : 'softSkillEduMngReg' ;
				
				$("#frmSoftSkillEduMng").attr("method", "post");
				$("#frmSoftSkillEduMng").attr("action", contextPath + "/internal/trnng/" + urlParam + ".do");
				$("#frmSoftSkillEduMng").submit();
			},
			...
			subscrAction : function(eduTrnngSeq) {
				...
				$("#frmSoftSkillEduMng").attr("method", "post");
				$("#frmSoftSkillEduMng").attr("action", contextPath + "/internal/trnng/jobskPrepareSubscriber.do");
				$("#frmSoftSkillEduMng").submit();
			},
			...
			updateAction : function( params ) {
				...
				var options = {
				    method: 'post',
				    url: contextPath + '/internal/trnng/updateSoftSkillEduMngArrayAjax.do',
				    data: params.data,
