...
var	jobskPrepareEduMngDtl = {
		name: 'jobskPrepareEduMngDtl',
		...
		afterBind: function() {
			...
			$("#frmJobskPrepareEduMngDtl").submit(function(e) {
			    var form$ = $(this);
		...
		fn: {
			deleteAction : function(e) {
				var form$ = $('#frmJobskPrepareEduMngDtl');
				...
				var options = {
				    method: 'post',
				    url: contextPath + '/internal/trnng/deleteJobskPrepareEduMngAjax.do',
				    data: param,
				    dataType: 'json',
				};				
			...
			updateAction : function(params) {
				...
				var options = {
					    method: 'post',
					    url: contextPath + '/internal/trnng/updateJobskPrepareEduMngAjax.do',
					    data: params.data,
					    dataType: 'json',
					};
...
function fnFileFormSave(){
		var params = {
			data: $('#frmJobskPrepareEduMngDtl').serializeObject()
		};
	$.when( jobskPrepareEduMngDtl.fn.updateAction( params ) ).done(function( result ) {
		alertify.alert( t( 'cpes.reg.success.msg' ), function (e) { if (e) {
			window.location.href = contextPath + '/internal/trnng/jobskPrepareEduMng.do';
		} });
	}).fail(function ( result ) {
		$('#frmJobskPrepareEduMngDtl').find("#btnDelete").attr('disabled', false);
		$('#frmJobskPrepareEduMngDtl').find("#btnSubmit").attr('disabled', false);
