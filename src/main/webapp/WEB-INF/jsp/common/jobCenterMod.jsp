...
<script src="${pageContext.request.contextPath}/js/pageLib/common/jobCenterMod.js"></script>
<script>
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3">
							...
							<div>
									<label for="addrKh"><spring:message code="field.dic.khmer" /> </label><input type="text" name="addrKh" id="addrKh"  value=""/>
							</div>
							<div>
									<label for="addrEn"><spring:message code="field.dic.english" /> </label><input type="text" name="addrEn" id="addrEn"  value=""/>
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<img id="uploadImg" src="${pageContext.request.contextPath}/images/board/dummy_photo.png" alt="">
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" value="save" class="bbs_btn save" onclick="updateJobCenterConf();"><spring:message code="cpes.btn.modify" /></button>
						<button type="button" value="delete" class="bbs_btn delete" onclick="deleteJobCenterConf();"><spring:message code="cpes.btn.delete" /></button>
