...
<script src="${pageContext.request.contextPath}/js/pageLib/common/grpCdMngMod.js"></script>
<script>
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" name="grpCd" id="grpCd" value="<c:out value="${grpCd}" />" readonly="true" />
						</td>
					</tr>
					<tr>
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
							<button type="button" id="save" name="save" value="save" class="bbs_btn save" onclick="updateGrpCdConf();"><spring:message code="field.dic.modify" /></button>
							<button type="button" value="delete" class="bbs_btn delete" onclick="deleteGrpCdConf();"><spring:message code="cpes.btn.delete" /></button>
					</span>
				</div>
				<!-- //bbs_btn_wrap -->
