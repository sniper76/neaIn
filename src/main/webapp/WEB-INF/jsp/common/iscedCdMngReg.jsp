...
<script src="${pageContext.request.contextPath}/js/pageLib/common/iscedCdMngReg.js"></script>
<script>
	...
	var iscedNmKhMsg  	= '<spring:message code="field.blank.isced.kh" text="Please Write Code!"></spring:message>';
	var iscedNmEnMsg  	= '<spring:message code="field.blank.isced.en" text="Please Write Code!"></spring:message>';
			...
			<fieldset>
						...
						<td colspan="3">
							<select id="oneDepth" name="oneDepth" title="oneDepth" style="width: 33%;"> 
								...
								<c:forEach items="${oneDepth}" var="item" varStatus="status">
									<option value="<c:out value="${item.iscedId}"/>" >
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" value="save" class="bbs_btn save" onclick="insertIscedCdConf();"><spring:message code="cpes.btn.save" /></button>
					</span>
				</div>
				<!-- //bbs_btn_wrap -->
