			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="mngId" id="mngId"  value="${user.mngId }" maxlength="50" size="50"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="password" name="userPwd" id="userPwd" value="${user.userPwd }" size="80" maxlength="110"/>
