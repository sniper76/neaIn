...
<div class="tab_obj n5">
	...
	<div class="bbs_basic">
		<form id="frm" method="post" >
			...
			<input type="hidden" id="urlChk" name="urlChk" value="nonNea" />
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3"><spring:message code="nea.user.mng.nonnea" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td ><input type="text" name="userTel" id="userTel" size="35" maxlength="20" /></td>
					...
					<tr>
						...
						<td ><input type="text" name="userCell" id="userCell" size="35" maxlength="20" /></td>
					...
					<tr>
						...
						<td colspan="3">
							...
							<input type="text" name="addrFullNm" id="addrFullNm" size="80" maxlength="100" required/>
							<div>
