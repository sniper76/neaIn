...
<script src="${pageContext.request.contextPath}/js/pageLib/common/iscoCdMngList.js"></script>
<script>
...
var endDtMsg    = '<spring:message code="popup.list.title.endDt"></spring:message>';
	...
	$(function() {
		common.invoker.invoke("iscoCdList");
	});
</script>
					...
					<tr>
						...
						<td>
							...
							<select id="searchKeyword">
								...
								<option value="1"><spring:message code="field.dic.isco.nm" /></option>
								<option value="2"><spring:message code="field.dic.isco.cd" /></option>
...
<table id="iscoCd" class="display dataTable bbs_table list">
    ...
    <thead>
        <tr>
			<th>No</th>
			<th scope="col"><spring:message code="field.dic.isco.cd" /></th>
            <th scope="col"><spring:message code="menu.menunm.depth" /></th>
			<th scope="col"><spring:message code="field.dic.isco.kh" /></th>
			<th scope="col"><spring:message code="field.dic.isco.en" /></th>
