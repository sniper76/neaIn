			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td ><input type="text" name="userNmKh" id="userNmKh" value=""  size="35" maxlength="50"/></td>
						<th scope="row"><span class="exactly y">necessary</span> <label for=""><spring:message code="field.dic.usernm.en" /></label></th>
						<td ><input type="text" name="userNmEn" id="userNmEn" value=""  size="35" maxlength="50"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="userId" id="userId"  size="35" maxlength="50"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="password" name="userPwd" id="userPwd"  size="80" maxlength="80"/>
						</br>
					...
					<tr>
						...
						<td colspan="3">
							<input type="password" name="userPwdconf" id="userPwdconf"  size="80" maxlength="80"/>
					...
					<tr>
						...
						<td ><input type="text" name="userTel" id="userTel"  size="35" maxlength="20" onKeyUp="onlyNumberCommon(this);"/></td>
						<th scope="row"><span class="exactly y">necessary</span> <label for=""><spring:message code="userChg.list.title.email" /></label></th>
						<td ><input type="text" name="userEmail" id="userEmail"  size="35" maxlength="50" /></td>
					</tr>
					<tr>
						<th scope="row"><span class="exactly y">necessary</span> <label for=""><spring:message code="field.dic.mobile" /></label></th>
						<td ><input type="text" name="userCell" id="userCell"  size="35" maxlength="20" onKeyUp="onlyNumberCommon(this);"/></td>
					...
					<tr>
						<th scope="row"><span class="exactly y">necessary</span> <label for=""><spring:message code="field.dic.passfail.cnt" /></label></th>
						<td colspan="3"><input type="text" name="pwdFailCnt" id="pwdFailCnt" size="3" maxlength="3" onKeyUp="onlyNumberCommon(this);"/></td>
					</tr>
					<tr>
						...
						<td colspan="3">
							...
							<input type="text" name="addrFullNm" id="addrFullNm" style="cursor:pointer"  size="80" maxlength="100" required readonly="readonly" onclick="popAddrLayerBtn('addrCd', 'addrFullCd', 'addrFullNm', 'addrFullNmView');"/>
							<div>
									<input type="text" name="addrDtl" id="addrDtl" size="94" maxlength="100"/>
							</div>
						</td>
