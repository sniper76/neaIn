...
<script src="${pageContext.request.contextPath}/js/pageLib/common/grpCdMngList.js"></script>
<script>
...
var endDtMsg    = '<spring:message code="popup.list.title.endDt"></spring:message>';
	...
	$(function() {
		common.invoker.invoke("grpCdList");
	});
</script>
...
<table id="grpCd" class="display dataTable bbs_table list">
...
<div class="put_box" style="text-align:right;">
	<form id="schFrm">
		<input type="hidden" name="grpCd" id="grpCd" value=""/>
	</form>
</div>
<div class="put_box" style="text-align:right;">
