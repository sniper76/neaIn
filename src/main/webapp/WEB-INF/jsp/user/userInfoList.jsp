...
<script src="${pageContext.request.contextPath}/js/pageLib/user/userInfoList.js"></script>

<script>
	$(function() {
		common.invoker.invoke("userInfoList");
	});
</script>
<div class="search_box">
	<!-- //top_box -->
	<div class="contents_box">
		<form id="frmUserInfoList">
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						...
						<td>
							<commCode:commcode codeKind="commCode" tagName="srchDivCd" grpCd="SRCH_USER_DIV_CD" drawType="select" initValue="SUD0000000001" exceptValue="" disable=""/>
							<input type="text" id="srchDivKeyword" name="srchDivKeyword" />
						</td>
...
<div class="bbs_btn_wrap clearfix">
	<span class="bbs_right">
		<input type="button" value="<spring:message code="field.dic.user.registration" />" id="btnUsrReg" class="bbs_btn type03 registration" />
		<input type="button" value="<spring:message code="field.dic.user.registration.excel" />" id="btnUsrReg" class="bbs_btn type03 registration" />
	</span>
</div>
