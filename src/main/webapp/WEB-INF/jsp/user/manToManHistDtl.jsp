...
<script src="${pageContext.request.contextPath}/js/pageLib/user/manToManHistDtl.js"></script>
<script>
	$(function() {
		common.invoker.invoke("manToManHistDtl");
	});
...
<c:if test="${'CMD0000000001' ne CounselBean.counselMethodDivCd}">
	...
	<div class="bbs_btn_wrap clearfix">
		<span class="bbs_left">
			<button type="button" class="bbs_btn list" onclick="SelectCounselHisList();">list</button>
		</span>
	</div>
	<!-- //bbs_btn_wrap -->
</div>
