...
<script src="${pageContext.request.contextPath}/js/pageLib/user/userElementaryInfoList.js"></script>

<script>
	$(function() {
		common.invoker.invoke("userElementaryInfoList");
	});
</script>
<div class="search_box">
	<!-- //top_box -->
	<div class="contents_box">
		<form id="frmUserElementaryInfoList">
			<fieldset>
...
<div class="bbs_btn_wrap clearfix">
	...
	<span class="bbs_right">
		<button type="button" id="btnUsrRegExcel" class="bbs_btn type03 registration" onclick="fnUserRegistrationExcel();"><spring:message code="field.dic.user.registration.excel" /></button>
		<button type="button" id="btnUsrReg" class="bbs_btn type03 registration" onclick="fnUserRegistration();"><spring:message code="field.dic.user.registration" /></button>
	</span>
</div>
