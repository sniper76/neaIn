...
<script src="${pageContext.request.contextPath}/js/pageLib/user/userCmpnyDtlInfoIntvwList.js"></script>

<script>
$(function() {
	common.invoker.invoke("userCmpnyDtlInfoIntvwList");
});
</script>

<form id="frmUserCmpnyDtlInfoIntvw">
...
<div class="bbs_basic">
	<table id="myTable" class="bbs_table list">
		...
		<tr>
			...
			<th scope="col"><spring:message code="field.dic.compny.vccy" /></th>
			<th scope="col"></th>
			<th scope="col"></th>
			<th scope="col"></th>
			<th scope="col"></th>
