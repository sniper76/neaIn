...
<script src="${pageContext.request.contextPath}/js/pageLib/user/userCmpnyDtlInfoAplcList.js"></script>

<script>
$(function() {
	common.invoker.invoke("userCmpnyDtlInfoAplcList");
});
</script>

<form id="frmUserCmpnyDtlInfoAplc">
...
<div class="bbs_btn_wrap clearfix">
	<span class="bbs_left">
		<a href="#" class="bbs_btn list" onclick="fnGoPageCompnyInfoListBack();"><spring:message code="button.list" /></a>
	</span>
</div>
<!--   //bbs_btn_wrap -->
