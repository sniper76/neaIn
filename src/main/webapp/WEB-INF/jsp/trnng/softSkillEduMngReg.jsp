...
<script src="${pageContext.request.contextPath}/js/pageLib/trnng/softSkillEduMngReg.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("softSkillEduMngReg");
	});
</script>
<style>
