...
<script src="${pageContext.request.contextPath}/js/pageLib/trnng/softSkillEduMng.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("softSkillEduMng");
	});
</script>
					...
					<tr>
						...
						<td>
							...
							<select id="searchKeyword" name="searchKeyword">
								...
								<option value="eduTrnngNm">직업지원교육명</option>
								<option value="teacherNm">강사명</option>
							</select>
						...
						<td colspan="3">
							<span class="date_box" style="padding-right:10px;">
								...
								<select id="periodKeyword" name="periodKeyword">
									...
									<option value="teachDt">강의일</option>
								</select>							
							</span>
...
<div class="bbs_basic">
	<table id="softSkillEduMngTable" class="display dataTable bbs_table list" style="word-break: break-all;" >
	    ...
	    <thead>
	        <tr>
	            ...
	            <th scope="col">직업직원교육명<p>(eduTrnngNm)</p></th>
	            <th scope="col">지역/Venue(area)</p></th>
	            <th scope="col">강사명(teacherNm1)</th>
	            <th scope="col">강의일시<p>(teachDt, teachHour, teachMinute, teachAmpm)</p></th>
	            <th scope="col">모집인원<p>(recrumtMemb)</p></th>
	            <th scope="col">모집상태<p>(recrumtStsCd)</p></th>
	            <th scope="col">신청자수<p>(subscriberCnt)</p></th>
	            <th scope="col">등록일시<p>(regDt)</p></th>
	            <th scope="col">등록자<p>(regUserNm)</p></th>
	        </tr>
	    </thead>
	</table>
</div>
