...
<script src="${pageContext.request.contextPath}/js/pageLib/trnng/softSkillEduMngDtl.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("softSkillEduMngDtl");
	});
</script>
<style>
...
<form id="frmSoftSkillEduMngDtl" >
<input type="hidden" id="eduTrnngSeq" name="eduTrnngSeq" value="<c:out value="${EduTrnngMngBean.eduTrnngSeq}" />" />
<input type="hidden" id="eduTrnngSubSeq" name="eduTrnngSubSeq" value="<c:out value="${EduTrnngMngBean.eduTrnngSubSeq}" />" />
		...
		<tr>
			...
			<td colspan="3">
 				<c:forEach items="${CommonCodeDtlBean}" var="item" varStatus="status">
					<c:if test="${item.grpCd eq 'RECRUMT_STS_CD' and item.dtlCd ne 'RSC0000000000'}">
...
<div class="bbs_basic margin_b_20">
	<div class="bbs_btn_wrap clearfix">
		<span class="bbs_left">
			<a href="${pageContext.request.contextPath}/internal/trnng/softSkillEduMng.do" class="bbs_btn list">list</a>
		</span>
