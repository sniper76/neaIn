...
<script src="${pageContext.request.contextPath}/js/pageLib/trnng/jobskPrepareEduMngDtl.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("jobskPrepareEduMngDtl");
	});
</script>
<style>
...
<form id="frmJobskPrepareEduMngDtl" >
	...
	<table class="bbs_table write">
		...
		<tr>
			...
			<td colspan="3">
               	...
               	<span id="addrFullNmView"><c:out value="${EduTrnngMngBean.addrFullNm}" escapeXml="false" /></span>
				<br/>
