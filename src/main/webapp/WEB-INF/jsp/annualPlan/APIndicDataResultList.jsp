...
<script src="${pageContext.request.contextPath}/js/pageLib/annualPlan/APIndicDataResultList.js"></script>

<script>
$(function() {
	common.invoker.invoke("APIndicDataResultList");
});
</script>
