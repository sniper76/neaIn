...
<script src="${pageContext.request.contextPath}/js/pageLib/jobsk/jobskDtlInfo.js"></script>

<script>
$(function() {
	common.invoker.invoke("jobskDtlInfo");
});
</script>

<form id="frmJobskDtlInfo">
...
<input type="hidden" id="resumeSeq" name="resumeSeq" value="<c:out value="${rtnBase.resumeSeq}" />" />
			...
			<tr> 
				...
				<td colspan="3">
					...
					<c:forEach items="${rtnIsco}" var="iscolist">
						<c:out value="${iscolist.iscoNm}" /><br>
					</c:forEach>
					</c:if>
				</td> 
			</tr> 
	...
	<div class="bbs_btn_wrap clearfix">
		<span class="bbs_left">
			<a href="${pageContext.request.contextPath}/internal/jobsk/jobskList.do" class="bbs_btn list"><spring:message code="cpes.btn.list" /></a>
		</span>
		<span class="bbs_right">
			<button type="button" class="bbs_btn modify" onclick="btnJobskDtlInfoModify();"><spring:message code="cpes.btn.modify" /></button>
		</span>
	</div>
	<!-- //bbs_btn_wrap -->
