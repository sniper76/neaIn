...
<script src="${pageContext.request.contextPath}/js/pageLib/jobsk/jobskApplicList.js"></script>

<script>
	$(function() {
		common.invoker.invoke("jobskApplicList");
	});
</script>
<div class="search_box">
	<!-- //top_box -->
	<div class="contents_box">
		<form id="frmJobskApplicList">
			<fieldset>
				...
				<table>
					...
					<tr>
						...
						<td>
							<commCode:commcode codeKind="commCode" tagName="resumeOpenYn" grpCd="READ_YN_CD" drawType="radio" initValue="" exceptValue="" disable=""/>
						</td>
					</tr>					
					<tr>
						<th scope="row"><spring:message code="field.dic.exam.stauts" /></th>
						<td>
							<commCode:commcode codeKind="commCode" tagName="applicTypeCd" grpCd="APPLIC_TYPE_CD" drawType="select" initValue="" exceptValue="" disable=""/>
						</td>
...
<div class="bbs_basic">
	<table id="myTable" class="bbs_table list">
		...
		<tr>
			...
			<th scope="col"><spring:message code="field.dic.exam.stauts" /></th>
			<th scope="col"></th>
			<th scope="col"></th>
			<th scope="col"></th>
