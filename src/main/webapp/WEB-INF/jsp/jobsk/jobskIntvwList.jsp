...
<script src="${pageContext.request.contextPath}/js/pageLib/jobsk/jobskIntvwList.js"></script>

<script>
	$(function() {
		common.invoker.invoke("jobskIntvwList");
	});
</script>
<div class="search_box">
	<!-- //top_box -->
	<div class="contents_box">
		<form id="frmJobskIntvwList">
			<fieldset>
...
<div class="bbs_basic">
	<table id="myTable" class="bbs_table list">
		...
		<tr>
			...
			<th scope="col"><spring:message code="field.dic.intvw.sggt.dt" /></th>
