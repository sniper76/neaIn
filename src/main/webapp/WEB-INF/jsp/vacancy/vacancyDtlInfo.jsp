...
<script src="${pageContext.request.contextPath}/js/pageLib/vacancy/vacancyDtlInfo.js"></script>

<script>
$(function() {
	common.invoker.invoke("vacancyDtlInfo");
});
</script>

<form id="frmVccyDtlInfo">
<input type="hidden" id="vacancySeq" name="userSeq" value="<c:out value="${rtnBase.vacancySeq}" />" />

	<h3><spring:message code="field.dic.vccy.dtl.info" /></h3>
	<div class="bbs_basic">
	...
	<div class="bbs_basic">
		<table class="bbs_table write margin_b_20"> 
			...
			<tr> 
				...
				<td><c:out value="${rtnBase.jcAgreeYn}" /></td>
	...
	<div class="bbs_btn_wrap clearfix">
		<span class="bbs_left">
			<a href="" class="bbs_btn list"><spring:message code="cpes.btn.list" /></a>
		</span>
		<span class="bbs_right">
			<a href="" class="bbs_btn list"><spring:message code="cpes.btn.modify" /></a>
		</span>
	</div>
	-->
