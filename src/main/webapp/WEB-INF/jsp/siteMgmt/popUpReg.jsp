...
<script src="${pageContext.request.contextPath}/js/pageLib/siteMgmt/popUpReg.js"></script>
<script>
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="title" id="title" size="80" maxlength="80"/></td>
					</tr>
					<tr>
						<th scope="row"><span class="exactly">necessary</span> <label for="">등록일시</label></th>
						<td><input type="text" name="regDate" id="regDate"  disabled="disabled" /></td>
					...
					<tr>
						<th scope="row"><span class="exactly y">necessary</span> <label for="">팝업 내용</label></th><!-- 필수 황목일 경우 exacly 에 클래스 y 추가 -->
						<td colspan="3">
							<textarea id="content" name="content" cols="1" rows="1" title="content" class="bbs_write_content"></textarea>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" value="save" class="bbs_btn save" onclick="insertPopUpConf();">Save</button>
