...
<script src="${pageContext.request.contextPath}/js/pageLib/siteMgmt/popUpMod.js"></script>
<script>
			...
			<fieldset>
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" value="save" class="bbs_btn save" onclick="updatePopUpConf();">Save</button>
						<button type="button" value="delete" class="bbs_btn delete" onclick="deletePopUpConf();">Delete</button>
