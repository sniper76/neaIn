...
<script src="${pageContext.request.contextPath}/js/pageLib/siteMgmt/bannerList.js"></script>
<script>
...
var endDtMsg    = '<spring:message code="popup.list.title.endDt"></spring:message>';
	...
	$(function() {
		common.invoker.invoke("bannerList");
	});
</script>
...
<div class="search_box">
	...
	<div class="contents_box">
		<form id="frm">
			<fieldset>
				<legend>banner Management Search</legend>
				<table>
					<caption>banner Management Search - Search, User Type, Period</caption>
					<tbody>
					<tr>
...
<div class="put_box" style="text-align:right;">
	<form id="schFrm">
		<input type="hidden" name="bannerSeq" id="bannerSeq" value=""/>
	</form>
</div>

<div class="bbs_btn_wrap clearfix">
	<span class="bbs_right">
		<button type="button" class="bbs_btn type03" onclick="insertBanner();">INSERT</button>
	</span>
</div>