...
<script src="${pageContext.request.contextPath}/js/pageLib/siteMgmt/bannerReg.js"></script>
<script>
			...
			<fieldset>
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" value="save" class="bbs_btn save" onclick="insertBannerConf();">Save</button>
