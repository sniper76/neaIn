...
<script src="${pageContext.request.contextPath}/js/pageLib/counsel/course.js"></script>
<script>
	var method = '<c:out value="${param.method}" />' == '' ? 'online' : ('<c:out value="${param.method}" />').toLowerCase();
	$(function() {
		common.invoker.invoke("course");
	});
</script>
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						...
						<td>
							<label for="counselTargetCd" class="skip">method selection</label>
							<select id="counselTargetCd" name="counselTargetCd">
...
<div class="bbs_basic">
	<table id="counselTable" class="display dataTable bbs_table list">
	    ...
	    <thead>
	        <tr>
	        	<th scope="col"></th>
	        	<th scope="col"><spring:message code="course.list.title.cate.div" /></th>
