...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinPhoto.js"></script>
<script>
...
<div class="search_box">
	...
	<div class="contents_box">
		<form id="frm">
			...
			<fieldset>
				<legend>Bulletin Photo Search</legend>
				<table>
					<caption>Bulletin Photo Search - Search, User Type, Period</caption>
					<tbody>
					<tr>
