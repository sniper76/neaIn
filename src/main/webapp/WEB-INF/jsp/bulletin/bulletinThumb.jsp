...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinThumb.js"></script>
<script>
...
<div class="search_box">
	...
	<div class="contents_box">
		<form id="frm">
			...
			<fieldset>
				<legend>Bulletin ThumbNail Search</legend>
				<table>
					<caption>Bulletin ThumbNail Search - Search, User Type, Period</caption>
					<tbody>
					<tr>
...
<table id="bulletinBasic" class="display dataTable bbs_table list">
    ...
    <thead>
        <tr>
			<th scope="col"></th>
			<th scope="col"><spring:message code="bulletin.dic.thumbnail.img" /></th>
