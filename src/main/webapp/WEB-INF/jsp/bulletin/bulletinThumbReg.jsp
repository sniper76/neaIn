...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinThumbReg.js"></script>
<script>
...
<div class="tab_obj n5">
	...
	<div class="bbs_basic">
		<form id="frm" method="post" >
			...
			<input type="hidden" name="bulletinTypeCd" id="bulletinTypeCd" value="BTC0000000002" />
				<input type="hidden" name="sysLangCd" id="sysLangCd" value="EN" />
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td>
							<commCode:commcode codeKind="commCode" tagName="viewYn" grpCd="FIELD_YN_CD" drawType="radio" initValue="" exceptValue="ALL" disable=""/>
						</td>
						<th scope="row"><span class="exactly ">necessary</span> <label for=""><spring:message code="bulletin.dic.notiyn" /></label></th>
						<td>
							<commCode:commcode codeKind="commCode" tagName="ntcYn" grpCd="FIELD_YN_CD" drawType="radio" initValue="" exceptValue="ALL" disable=""/>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<table class="bbs_table write">
						...
						<tbody>
						<tr>
								<th scope="row"><span class="exactly y">necessary</span> <label for=""><spring:message code="bulletin.dic.thumbnail.img" /></label></th><!-- 필수 황목일 경우 exacly 에 클래스 y 추가 -->
							<td colspan="3">
						...
						<tr>
							...
							<td colspan="3">
								<textarea id="contentKhTxt" name="contentKhTxt" cols="1" rows="1" title="contentKh" class="bbs_write_content"></textarea>
							</td>
						</tr>
						<tr>
