...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinPhotoReg.js"></script>
<script>
...
<div class="tab_obj n5">
	...
	<div class="bbs_basic">
		<form id="frm" method="post" >
				...
				<input type="hidden" name="bulletinTypeCd" id="bulletinTypeCd" value="BTC0000000003" />
