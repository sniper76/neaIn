...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinFaqMod.js"></script>
<script>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="bulletinCateNm" id="bulletinCateNm" size="80" maxlength="300" value="${bulletinInfo.bulletinCateNm }"  readonly="readonly"/></td>
						</tr>
						<tr>
