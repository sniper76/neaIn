...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinFaqReg.js"></script>
<script>
...
<div class="tab_obj n5">
	...
	<div class="bbs_basic">
		<form id="frm" method="post" >
			...
			<input type="hidden" name="bulletinTypeCd" id="bulletinTypeCd" value="BTC0000000005" />
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						<th scope="row"><span class="exactly y">necessary</span> <label for=""><spring:message code="bulletin.dic.cate.set" /></label></th><!-- 필수 황목일 경우 exacly 에 클래스 y 추가 -->
						<td colspan="3">
