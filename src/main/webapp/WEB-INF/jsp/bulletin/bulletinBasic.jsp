...
<script src="${pageContext.request.contextPath}/js/pageLib/bulletin/bulletinBasic.js"></script>
<script>
...
var proccesMsg 	= '<spring:message code="cpes.process.success.msg" text="Success"></spring:message>';
	...
	$(function() {
		common.invoker.invoke("bulletinBasicList");
	});
</script>
...
<div class="search_box">
	...
	<div class="contents_box">
		<form id="frm" name="frm">
				...
				<fieldset>
				<legend>Bulletin Basic Search</legend>
				<table>
					<caption>Bulletin Basic Search - Search, User Type, Period</caption>
					<tbody>
					<tr>
					...
					<tr>
						...
						<td>
							<label for="Search_sel" class="skip">category selection</label>
							<commCode:commcode codeKind="commCode" tagName="viewYn" grpCd="FIELD_YN_CD" drawType="select" initValue="" exceptValue="" disable=""/>
						</td>
...
<table id="bulletinBasic" class="display dataTable bbs_table list">
    ...
    <thead>
        <tr>
        	<th scope="col"></th>
			<th scope="col"><spring:message code="bulletin.dic.title" /></th>
