...
<script src="${pageContext.request.contextPath}/js/pageLib/info/bulletinBasicReg.js"></script>
<script>
	$(function() {
		common.invoker.invoke("bulletinBasicReg");
	});
</script>
...
<div class="tab_obj n5">
	...
	<div class="bbs_basic">
		<form id="frmBulletinBasicReg" method="post" >
			<!-- To-Do 게시판관리번호 정의 필요 -->
