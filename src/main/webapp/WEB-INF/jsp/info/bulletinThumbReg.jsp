...
<script src="${pageContext.request.contextPath}/js/pageLib/info/bulletinThumbReg.js"></script>
<script>
	$(function() {
		common.invoker.invoke("bulletinThumbReg");
	});	
</script>
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td><input type="text" name="writerNm" id="writerNm"  value="<c:out value="${BulletinBean.user.userNm}" />" disabled="disabled" /></td>
				...
				<table class="bbs_table write">
						...
						<tbody>
						<tr>
							<th scope="row"><span class="exactly y">necessary</span> <label for="">썸네일 이미지</label></th><!-- 필수 황목일 경우 exacly 에 클래스 y 추가 -->
							<td colspan="3">
