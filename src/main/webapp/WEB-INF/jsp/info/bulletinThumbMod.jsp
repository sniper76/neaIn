...
<script src="${pageContext.request.contextPath}/js/pageLib/info/bulletinThumbMod.js"></script>
<script>
	$(function() {
		common.invoker.invoke("bulletinThumbMod");
	});
</script>
<%-- 
...
<div class="tab_obj n5">
	...
	<div class="bbs_basic">
		<form id="frmBulletinThumbMod" method="post" >
				...
				<fieldset>
					...
					<table class="bbs_table write">
						...
						<tr>
								...
								<td colspan="3"><input type="text" name="titleKh" id="titleKh" readonly="readonly"  value="<c:out value="${BulletinBean.titleKh}" />" required /></td>
							</tr>
							<tr>
								<th scope="row"><span class="exactly y">necessary</span> <label for="">제목(English)</label></th><!-- 필수 황목일 경우 exacly 에 클래스 y 추가 -->
								<td colspan="3"><input type="text" name="titleEn" id="titleEn" readonly="readonly"  value="<c:out value="${BulletinBean.titleEn}" />" required /></td>
							</tr>
							<tr>
