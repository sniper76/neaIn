...
<script src="${pageContext.request.contextPath}/js/pageLib/info/bulletinThumb.js"></script>
<script>
	$(function() {
		common.invoker.invoke("bulletinThumb");
	});
</script>
...
<table id="bulletinThumbTable" class="display dataTable bbs_table list">
