...
<script src="${pageContext.request.contextPath}/js/pageLib/info/bulletinBasic.js"></script>
<script>
	$(function() {
		common.invoker.invoke("bulletinBasic");
	});
</script>
...
<table id="bulletinBasicTable" class="display dataTable bbs_table list">
