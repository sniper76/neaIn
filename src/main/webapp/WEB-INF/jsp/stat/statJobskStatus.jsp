...
<script src="${pageContext.request.contextPath}/js/pageLib/stat/statJobskStatus.js"></script>
...
var currentTab = "tabJobskTotalStatus";
var srchTermDivCd = "STD0000000001";

$(function() {
	common.invoker.invoke("statJobskStatus");	
...
<form id="frmStatJobskStatus" name="frmStatJobskStatus">
...
<div class="bbs_tab action">
	<ul class="clearfix">
		<li class="on"><a href="javascript:void(0);" id="tabJobskTotalStatus" name="tabJobskTotalStatus" onclick="fnTabClick('tabJobskTotalStatus');"><spring:message code="field.dic.total.info" /></a></li>
		...
		<li><a href="javascript:void(0);" id="tabAgeStatus" name="tabAgeStatus" onclick="fnTabClick('tabAgeStatus');"><spring:message code="field.dic.age" /></a></li>
		<li><a href="javascript:void(0);" id="tabEducationStatus" name="tabEducationStatus" onclick="fnTabClick('tabEducationStatus');"><spring:message code="field.dic.edu.level" /></a></li>
		<li><a href="javascript:void(0);" id="tabOccupationStatus" name="tabOccupationStatus" onclick="fnTabClick('tabOccupationStatus');"><spring:message code="field.dic.isco" /></a></li>
	</ul>
</div>
