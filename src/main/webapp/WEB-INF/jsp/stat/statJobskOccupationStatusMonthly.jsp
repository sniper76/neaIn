...
<%
	...
	String fOccupation = request.getAttribute("fOccupation").toString();
...
<%
	...
	OOFFile file = oof.addFile("crf.root", "%root%/crf/stat/statJobskOccupationStatusMonthly.crf");
	oof.addConnectionData("*", "CPES_DEV");
	oof.addField("JC_CD", jcCd);
	oof.addField("START_DATE", startDate);
	oof.addField("END_DATE", endDate);
	oof.addField("OCCUPATION", fOccupation);
