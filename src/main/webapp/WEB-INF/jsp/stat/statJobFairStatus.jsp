...
<script src="${pageContext.request.contextPath}/js/pageLib/stat/statJobFairStatus.js"></script>
...
var currentTab = "tabNCPFStatus";
var srchTermDivCd = "STD0000000001";

$(function() {
	common.invoker.invoke("statJobFairStatus");	
...
<div class="bbs_tab action">
	<ul class="clearfix">
		<li class="on"><a href="javascript:void(0);" id="tabNCPFStatus" name="tabNCPFStatus" onclick="fnTabClick('tabNCPFStatus');"><spring:message code="field.dic.jobfair.ncpf" /></a></li>
		<li><a href="javascript:void(0);" id="tabPCPFStatus" name="tabPCPFStatus" onclick="fnTabClick('tabPCPFStatus');"><spring:message code="field.dic.jobfair.pcpf" /></a></li>
		<li><a href="javascript:void(0);" id="tabEmploymentForumStatus" name="tabEmploymentForumStatus" onclick="fnTabClick('tabEmploymentForumStatus');"><spring:message code="field.dic.employment.forum" /></a></li>
	</ul>
</div>
