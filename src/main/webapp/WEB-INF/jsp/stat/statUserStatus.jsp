...
<script src="${pageContext.request.contextPath}/js/pageLib/stat/statUserStatus.js"></script>
...
var currentTab = "tabUserTotalStatus";
var srchTermDivCd = "STD0000000001";

$(function() {
	common.invoker.invoke("statUserStatus");	
...
<div class="bbs_tab action">
	<ul class="clearfix">
		<li class="on"><a href="javascript:void(0);" id="tabUserTotalStatus" name="tabUserTotalStatus" onclick="fnTabClick('tabUserTotalStatus');"><spring:message code="field.dic.total.info" /></a></li>
		...
		<li><a href="javascript:void(0);" id="tabJobskStatus" name="tabJobskStatus" onclick="fnTabClick('tabJobskStatus');"><spring:message code="bulletin.dic.pms.jobsk" /></a></li>
		<li><a href="javascript:void(0);" id="tabUserCompnyStatus" name="tabUserCompnyStatus" onclick="fnTabClick('tabUserCompnyStatus');"><spring:message code="field.dic.compny" /></a></li>
		<li><a href="javascript:void(0);" id="tabUserInsttStatus" name="tabUserInsttStatus" onclick="fnTabClick('tabUserInsttStatus');"><spring:message code="field.dic.instt" /></a></li>
	</ul>
</div>
