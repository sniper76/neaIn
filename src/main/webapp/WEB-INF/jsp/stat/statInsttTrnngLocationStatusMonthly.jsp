...
<%
	...
	String activeInsttCnt = request.getAttribute("activeInsttCnt").toString();
	String totalTrnngCnt = request.getAttribute("totalTrnngCnt").toString();
	String trnngProgCnt = request.getAttribute("trnngProgCnt").toString();
	String scholarshipProgCnt = request.getAttribute("scholarshipProgCnt").toString();
...
<%
	...
	OOFFile file = oof.addFile("crf.root", "%root%/crf/stat/statInsttTrnngLocationStatusMonthly.crf");
	oof.addConnectionData("*", "CPES_DEV");
	oof.addField("JC_CD", jcCd);
	oof.addField("START_DATE", startDate);
	oof.addField("END_DATE", endDate);
	oof.addField("LOCATION", location);
	oof.addField("TOTAL_INSTT_CNT", insttCnt);
	oof.addField("ACTIVE_INSTT_CNT", activeInsttCnt);
	oof.addField("TOTAL_TRNNG_CNT", totalTrnngCnt);
	oof.addField("TRNNG_PROG_CNT", trnngProgCnt);
	oof.addField("SCHOLARSHIP_PROG_CNT", scholarshipProgCnt);
