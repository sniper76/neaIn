...
<script src="${pageContext.request.contextPath}/js/pageLib/fair/insttJoinMng.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("insttJoinMng");

		$('#btn_insertInsttInvitation').on('click', function(){
			if($('#fairSeq').val() == ""){
				alertify.alert("<spring:message code='invitation.fair.noSelect'/>");
				return false;
			}
			$('#insttInvitationPopup').show();
		});
	});
</script>
	...
	<div class="contents_box">
			<fieldset>
				...
				<table>
					<tbody>
					<tr>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="insttJoinMng.fn.pageActionPartici();"><spring:message code="field.dic.partcptn.instt" /></a></td>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="insttJoinMng.fn.pageActionRequest();"><spring:message code="field.dic.req.instt" /></a></td>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="insttJoinMng.fn.pageActionInvite();"><spring:message code="field.dic.invite.instt" /></a></td>
					</tr>
					</tbody>
				</table>
			</fieldset>
...
<div class="bbs_basic">
	<table id="insttJoinMngTable" class="display dataTable bbs_table list" style="word-break: break-all;" >
	...
	<div class="put_box">
		<button type="button" class="bbs_btn save" id="btn_insertInsttInvitation">SEARCH</button>
	</div>
</div>

<%@ include file="/WEB-INF/jsp/common/insttInvitationLayer.jsp"%>