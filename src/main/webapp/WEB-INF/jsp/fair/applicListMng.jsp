...
<script src="${pageContext.request.contextPath}/js/pageLib/fair/applicListMng.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("applicListMng");
	});
</script>
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						...
						<th scope="row"><spring:message code="field.dic.open.yn" /></th>
						<td>
							<commCode:commcode codeKind="commCode" tagName="resumeOpenYn" grpCd="FIELD_YN_CD" drawType="radio" initValue="ALL" exceptValue="" disable=""/>
 						</td>						
					</tr>
					<tr>
						<th scope="row"><spring:message code="field.dic.aplc.status" /></th>
						<td>
							<commCode:commcode codeKind="commCode" tagName="applicProcCd" grpCd="APPLIC_PROC_CD" drawType="select" initValue="" exceptValue="" disable=""/>
						</td>
						<th scope="row"><spring:message code="field.dic.referral.yn" /></th>
						<td>
							<commCode:commcode codeKind="commCode" tagName="referralYn" grpCd="FIELD_YN_CD" drawType="radio" initValue="ALL" exceptValue="" disable=""/>
						</td>						
					</tr>
					<tr>
...
<div class="bbs_basic">
	<table id="applicListMngTable" class="display dataTable bbs_table list" style="word-break: break-all;" >
	    ...
	    <thead>
	        <tr>
	            ...
	            <th scope="col">이력서명<p>(resumeTitle)</p></th>
	            <th scope="col">이메일<p>(userEmail)</p></th>
	            <th scope="col">연령<p>(age)</p></th>
	            ...
	            <th scope="col">입사지원일시<p>(regDt)</p></th>
	            <th scope="col">열람일시<p>(resumeOpenDt)</p></th>
	            <th scope="col">알선여부<p>(referralYn)</p></th>
	            <th scope="col">심사상태<p>(applicProcCd)</p></th>
