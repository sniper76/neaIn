...
<script src="${pageContext.request.contextPath}/js/pageLib/fair/workshopReg.js"></script>
<script>
	...
	$(function() {
		common.invoker.invoke("workshopReg");
			...
			<fieldset>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="workshopNm" id="workshopNm" style="width: 100%;"/></td>
					</tr>
					<tr>
						...
						<td colspan="3"><textarea rows="" cols="" name="expln" id="expln"></textarea></td>
					</tr>
					<tr>
						<th scope="row"><span class="exactly">necessary</span> <label for=""><spring:message code="field.dic.workshopThum" /></label></th>
						<td colspan="3">
							<img id="thumFileImg" class="previewImg" src="" alt="" style="width: 225px; height: 225px;">
					...
					<tr>
						...
						<td colspan="3">
							<span class="period_box">
								<span class="date_box">
									<input type="text" id="workshopDt" name="workshopDt" value="" class="datepicker" title="date Select from calendar" placeholder="date" readonly="readonly" />
								</span>
							</span>
					...
					<tr>
						...
						<td colspan="3">
							...
							<input type="hidden" name="workshopAddrCd" id="addrCd" value=""  />
               				<input type="hidden" name="workshopAddrFullCd" id="addrFullCd" value="" />
               				<input type="text" name="workshopAddrFullNm" id="addrFullNm" value="" readonly="readonly" style="width: 40%;"/>
               				<input type="text" name="workshopAddrDtl" id="addrFullDtl" value="" style="width: 40%;" />
						</td>
					</tr>
					<tr>
						<th scope="row"><span class="exactly">necessary</span> <label for=""><spring:message code="field.dic.lectureRoom" /></label></th>
						<td colspan="3"><input type="text" name="lectureRoom" id="lectureRoom" style="width: 100%;"/></td>
					</tr>
					<tr>
						<th scope="row"><span class="exactly">necessary</span> <label for=""><spring:message code="field.dic.tuition.fee" /></label></th>
						<td colspan="3">
							<commCode:commcode codeKind="commCode" tagName="tuitionGrpCd" grpCd="TUITION_GRP_CD" drawType="radio" initValue="" exceptValue="ALL" disable="true"/>
							<input type="text" name="tuition" id="tuition" class="inputNo" readonly="readonly"/><label for="tuition">$</label>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<input type="text" name="googleMapLink" id="googleMapLink" style="width: 100%;" />
						</td>
					</tr>
					</tbody>
				</table>
				...
				<table class="bbs_table write">
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="mngerNm" id="mngerNm" style="width: 100%;"/></td>
					</tr>
					<tr>
						...
						<td><input type="text" name="mngerTel" id="mngerTel" class="inputNo" style="width: 100%;"/></td>
						...
						<td><input type="text" name="mngerEmail" id="mngerEmail" class="inputEmail" style="width: 100%;"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<img id="teacherPhoto2Img" class="previewImg" src="" alt="" style="width: 225px; height: 225px;">
					...
					<tr>
						...
						<td colspan="3"><textarea rows="" cols="" id="teacherBhist1" name="teacherBhist1"></textarea></td>
					</tr>
					<tr>
						<th scope="row"><span class="exactly">necessary</span> <label for=""><spring:message code="field.dic.teacherBhist2" /></label></th>
						<td colspan="3"><textarea rows="" cols="" id="teacherBhist2" name="teacherBhist2"></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="radio" id="useYn_Y" name="useYn" value="Y" /><label for="useYn_Y">Y</label>
							<input type="radio" id="useYn_N" name="useYn" value="N" /><label for="useYn_N">N</label>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<div class="bbs_btn_wrap clearfix">
					...
					<span class="bbs_right">
						<button type="button" value="save" class="bbs_btn save" onclick="insertWorkshopSave();"><spring:message code="button.create" /></button>
