...
<script src="${pageContext.request.contextPath}/js/pageLib/fair/compnyJoinMng.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("compnyJoinMng");

		$('#btn_insertCoInvitation').on('click', function(){
			if($('#fairSeq').val() == ""){
				alertify.alert("<spring:message code='invitation.fair.noSelect'/>");
				return false;
			}

			$('#coInvitationPopup').show();
		});
	});
</script>
...
<div class="bbs_basic">
	<table id="compnyJoinMngTable" class="display dataTable bbs_table list" style="word-break: break-all;" >
	...
	<div class="put_box">
		<button type="button" class="bbs_btn save" id="btn_insertCoInvitation">SEARCH</button>
	</div>
</div>

<%@ include file="/WEB-INF/jsp/common/companyInvitationLayer.jsp"%>
<%-- <c:import url="${pageContext.request.contextPath}/internal/fair/coInvitationPopup.do"></c:import> --%>
