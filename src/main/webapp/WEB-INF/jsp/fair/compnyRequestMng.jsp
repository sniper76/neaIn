...
<script src="${pageContext.request.contextPath}/js/pageLib/fair/compnyRequestMng.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("compnyRequestMng");
	});
</script>
	...
	<div class="contents_box">
			<fieldset>
				...
				<table>
					<tbody>
					<tr>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="compnyRequestMng.fn.pageActionPartici();"><spring:message code="field.dic.fair.compny.view" /></a></td>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="compnyRequestMng.fn.pageActionRequest();"><spring:message code="field.dic.intvw.compny.name" /></a></td>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="compnyRequestMng.fn.pageActionInvite();"><spring:message code="field.dic.invite.compny.name" /></a></td>
					</tr>
					</tbody>
				</table>
			</fieldset>
...
<div class="bbs_basic">
	<table id="compnyRequestMngTable" class="display dataTable bbs_table list" style="word-break: break-all;" >
