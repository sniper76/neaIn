...
<script src="${pageContext.request.contextPath}/js/pageLib/fair/insttRequestMng.js"></script>
<script type="text/javascript">
	$(function() {
		common.invoker.invoke("insttRequestMng");
	});
</script>
	...
	<div class="contents_box">
			<fieldset>
				...
				<table>
					<tbody>
					<tr>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="insttRequestMng.fn.pageActionPartici();"><spring:message code="field.dic.partcptn.instt" /></a></td>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="insttRequestMng.fn.pageActionRequest();"><spring:message code="field.dic.req.instt" /></a></td>
						<td scope="row" style="text-align:center"><a href="javascript:void(0);" onclick="insttRequestMng.fn.pageActionInvite();"><spring:message code="field.dic.invite.instt" /></a></td>
					</tr>
					</tbody>
				</table>
			</fieldset>
...
<div class="bbs_basic">
	<table id="insttRequestMngTable" class="display dataTable bbs_table list" style="word-break: break-all;" >
